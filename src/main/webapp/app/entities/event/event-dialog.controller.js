(function() {
    ...
    EventDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'entity', 'Event', 'User', 'Location', 'PotentialEventDate'];

    function EventDialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, entity, Event, User, Location, PotentialEventDate) {
        var vm = this;
